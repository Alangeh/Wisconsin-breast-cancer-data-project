...
#Function to calculate the euclidean distance between data points and data centers
...
#Function to replace missing values with special character "?"
#computes the mean and imputes missing value into the dataframe.
...
#This function initializes the centroids from the datapoints in the dataset
...
#Function to calculate distance between datapoint and cluster centers and assign clusters
...
#Function to recalculate the new centroids
...
########################################################################################################################
    ...
    colNames = ['Scn', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'A9',
                'A10', 'CLASS']
    raw_data = pd.read_csv(url, names=colNames) #get data from dataset
...
########################################################################################################################
 ############################# Phase 2 ######################################
    ...
    print('-'*30,'Final Mean','-'*30) #print final means after 100 iterations
    print('u2: ', list(u2))
    print('\n')
    print('u4: ', list(u4))
